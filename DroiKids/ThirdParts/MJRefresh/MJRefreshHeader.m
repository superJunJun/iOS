...
//            self.updatedTimeLabel.text = [NSString stringWithFormat:@"%@ %@",NSLocalizedString(@"pull_to_refresh_header_last_time", nil) ,time];
//        } else {
//            self.updatedTimeLabel.text = [NSString stringWithFormat:@"%@",NSLocalizedString(@"pull_to_refresh_header_last_time", nil)];
//        }
