...
static const char kKeyChainUDIDAccessGroup[] = "TXMBT3MXY6.com.tydtech.droikids";//"YOURAPPID.com.cnblogs.smileEvday";
...
+ (NSString*)getUDIDFromKeyChain
{
    ...
    [dictForQuery setValue:[NSString stringWithUTF8String:kKeychainUDIDItemIdentifier] forKey:(__bridge NSString *)(kSecAttrDescription)];
